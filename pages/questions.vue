    ...
    <v-row style="min-height: 800px">
      ...
      >
        <div style="background-color: #fdf8ef; width: 100%">
          <p class="font-weight-bold pa-4">الاسئلة المكررة</p>
        </div>
...
useHead({
  title: "القانوني - الاسئلة المكررة",
  meta: [
    { name: "description", content: "تحتوي هذه الصفحة على الاسئلة المكررة" },
    {
      property: "og:description",
      content: "تحتوي هذه الصفحة على الاسئلة المكررة",
    },
