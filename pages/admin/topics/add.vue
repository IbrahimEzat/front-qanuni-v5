<template>
    <div>
        <v-container style="border: 1px solid grey; border-radius: 5px;">
            ...
            <div class="d-flex">
                <label class="me-3 mt-2"> اختر القسم الذي يتبع له التصنيف: </label>
            ...
            <div style="text-align: end">
                <v-btn :loading="addLoading" variant="outlined" class="rounded-pill mt-3" @click="addTopic"
                    style="color: white; background-color: rgb(28, 173, 76)">
                    <p class="text-h6">اضافة</p>
                </v-btn>
